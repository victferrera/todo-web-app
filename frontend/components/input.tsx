            ...
            <div className="flex justify-center">
                <div className="w-1/2">
                    <div className="flex items-center justify-center mt-10 w-full">
                        <input type="text" onKeyDown={() => submitHandler} name="todoTitle" placeholder="What needs to be done?" className="bg-[#F1ECE6] w-full h-14 rounded-s-3xl block p-5 focus:outline-[#DA8554] text-[#676564] text-2xl" />
                        <span>
